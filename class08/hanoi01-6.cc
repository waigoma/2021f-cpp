...
//    cout << setfill(' ');
//    cout << right << setw(6) << "|" << setw(10) << "|" << setw(10) << "|" << endl;
//    for (int i = 0; i < DISK_SIZE; i++) {
//        if (plate_num[0]);
//        int paddingA = (board[0][i] - 1);
//        int paddingB = (board[1][i] - 1);
//        int paddingC = (board[2][i] - 1);
//        string a = board[0][i] > 0 ? string(2 * board[0][i] - 1, 'x') : "|";
//        string b = board[1][i] > 0 ? string(2 * board[1][i] - 1, 'x') : "|";
//        string c = board[2][i] > 0 ? string(2 * board[2][i] - 1, 'x') : "|";
//        cout << right << setw(6 + paddingA) << a << setw(10 - paddingB - paddingA) << b << setw(10 - paddingC - paddingB) << c << endl;
//    }
